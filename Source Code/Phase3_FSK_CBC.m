...
for k = 1: nSteps
    transmittedSignal(k) = cbcSignal(ceil(k*dataRate/samplingFrequency));
end
...
for SNR = SNRvalues
    ...
    for sample = 1:20
        ...
        finalResultDecoded = decode(result, codeword_len,msgword_len,'cyclic/binary',genpoly,trt);
        % Calculating error
